...
parfor i = 1:nrun
     ulego_coreeim(paras{i}{1}, paras{i}{2}, 'EIMnext', 'EIM_eval',  'normalization_z');
     ulego_coreble(paras{i}{1}, paras{i}{2}, 'normalization_z');
     ulego_coregen(paras{i}{1}, paras{i}{2}, 'normalization_z');
end
